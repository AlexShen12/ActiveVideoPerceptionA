...
echo ""
echo " NOTE: OmniVideoBench is audio-visual. For best results run with"
echo " ActiveVideoPerceptionA (AAVP) and audio_enabled: true in avp/config.json."
echo " See avp/config.aavp.json for a template."
echo "========================================================"
